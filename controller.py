...
response = requests.get("https://github.com/T3tsuo/PokemonScripts/archive/refs/heads/main.zip")
response.raise_for_status()

with zipfile.ZipFile(BytesIO(response.content)) as zfile:
    print(f"Extracting all files to {os.path.abspath('scripts')}")
    zfile.extractall('scripts')
