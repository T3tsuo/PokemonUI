...
class CheckProcess(QRunnable):
    ...
    @pyqtSlot()
    def run(self):
        global level_process, is_run
        while level_process.is_alive() and is_run:
...
class Ui_LevelUI(object):
    def setupUi(self, LevelUI, dict):
        global window, uis
        uis = dict
        window = LevelUI
        font = QtGui.QFont()
        ...
        LevelUI.setStyleSheet("*{\n"
                              ...
                              "    background-color: #16191d;\n"
                              "}")
        self.centralwidget = QtWidgets.QWidget(parent=LevelUI)
        ...
        self.sweetscentinput = QtWidgets.QTextEdit(parent=self.subconfigitem)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.sweetscentinput.setFont(font)
        self.sweetscentinput.setStyleSheet("background-color: transparent; border: 1px solid white;")
        self.sweetscentinput.setObjectName("sweetscentinput")
        self.verticalLayout_8.addWidget(self.sweetscentinput)
        ...
        self.logtitle = QtWidgets.QWidget(parent=self.MainContainer)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred,
                                           QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(2)
        ...
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.logtitle)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.label = QtWidgets.QLabel(parent=self.logtitle)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.verticalLayout_5.addWidget(self.label, 0, QtCore.Qt.AlignmentFlag.AlignTop)
        self.scrollLog = QtWidgets.QScrollArea(parent=self.logtitle)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 590, 239))
        ...
        self.verticalLayout_2.addWidget(self.logtitle)
        self.horizontalLayout.addWidget(self.MainContainer)
        LevelUI.setCentralWidget(self.centralwidget)
        ...
        self.runBtn.clicked.connect(self.run_level_farming)
        self.runBtn.setAutoDefault(True)

        self.retranslateUi(LevelUI)
        QtCore.QMetaObject.connectSlotsByName(LevelUI)
    ...
    def run_level_farming(self):
        ...
        elif is_run and level_process is not None and level_process.is_alive():
            self.hide_status()
    ...
    def retranslateUi(self, LevelUI):
        _translate = QtCore.QCoreApplication.translate
        LevelUI.setWindowTitle(_translate("MainWindow", "PokemonUI"))
        ...
        self.title.setText(_translate("MainWindow", "Level Farming"))
        self.sweetscentinput.setPlaceholderText(_translate("MainWindow", "How many sweet scents"))
